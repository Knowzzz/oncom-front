...
const ModalContent = ({ contentType }) => {
  if (contentType === "confidentiality") {
    return (
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Similar, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SmartUse, France.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Similar, accessible from{" "}
              <a
                href="https://www.similar.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.similar.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: smartuse.similar@gmail.com</li>
        </ul>
      </div>
    );
  }
  ...
  if (contentType === "cookies") {
    return (
      <div>
        <h1>Cookie Policy for Similar</h1>

        <p>
          This is the Cookie Policy for Similar, accessible from
          https://similar.com
        </p>
